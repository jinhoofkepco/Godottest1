...
public static class BattleConfig
{
    ...
    public const float OccupancyWinRatio = 0.9f;
    public const int StartGold = 180;
    public const int EnemyStartGold = 120;
    public const float PassiveIncomePerSecond = 3f;
    ...
    public const float MeleeSpeed = 1.45f;
    ...
    public const float RangedSpeed = 1.25f;
    ...
    public const float SiegeSpeed = 0.80f;
    ...
    public const float DragonSpeed = 1.70f;
