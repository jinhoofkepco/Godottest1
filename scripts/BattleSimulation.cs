...
public partial class BattleSimulation : Node
{
    ...
    private readonly int[] _firingTargetIds = new int[MaxUnits];
    private readonly Vector2[] _firingPositions = new Vector2[MaxUnits];
    private readonly int[] _firingSlotIndices = new int[MaxUnits];
    private readonly byte[] _firingLateral = new byte[MaxUnits];
    private readonly Vector2[] _yieldCorrections = new Vector2[MaxUnits];
    private readonly byte[] _yieldTouched = new byte[MaxUnits];
    private readonly int[] _yieldTouchedIndices = new int[MaxUnits];
    private int _yieldTouchedCount;
    ...
    private readonly int[] _shotSourceIds = new int[MaxEvents];
