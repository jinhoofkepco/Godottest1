...
2026-07-19 Apple M4, Godot 4.7 stable에서 22개 열 전체에 근접 200기·원거리 200기를 균등 배치하고 30틱 워밍업 뒤 300틱을 측정했습니다. 평균 **9.122 ms**, p95 **12.072 ms**, 최대 **18.328 ms**, 틱당 최대 적 후보 검사 **2,259회**였습니다. 로컬 기본 게이트는 후보 검사 12,000회 미만과 평균/p95 16.667 ms 미만입니다. GitHub 호스티드 러너는 기기 성능 편차로 APK 빌드가 막히지 않도록 `STRESS_TICK_BUDGET_MS=30.0`을 사용하되 동일한 후보 검사 게이트를 유지하며, 이는 30 Hz 고정 시뮬레이션의 33.333 ms 틱 기한보다 엄격합니다. 최대 단일 틱은 함께 공개하며 Android 기기의 절대 수치는 기기에 따라 달라집니다.
