...
2026-07-19 Apple M4, Godot 4.7 stable에서 22개 열 전체에 근접 200기·원거리 200기를 균등 배치하고 30틱 워밍업 뒤 300틱을 측정했습니다. 평균 **9.122 ms**, p95 **12.072 ms**, 최대 **18.328 ms**, 틱당 최대 적 후보 검사 **2,259회**였습니다. 평균과 p95는 60 FPS 예산 16.667 ms 미만이며, 테스트는 후보 검사 12,000회 이상 또는 평균/p95가 예산 이상이면 실패합니다. 최대 단일 틱은 함께 공개하며 Android/CI 절대 시간은 기기에 따라 달라집니다.
