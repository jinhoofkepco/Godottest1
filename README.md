...
2026-07-19 Apple M4, Godot 4.7 stable 로컬 측정에서 데이터 유닛 400개·30틱 워밍업 뒤 300틱은 평균 **0.714 ms**, p95 **2.184 ms**, 최대 **2.827 ms**, 최대 버킷 후보 검사 **22,815회**였습니다. 60 FPS 프레임 예산 16.667 ms보다 낮으며, 테스트는 평균 또는 p95가 이 예산을 넘으면 실패합니다. Android/CI의 절대 수치는 기기에 따라 달라집니다.
